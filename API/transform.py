...
"""
In this file, all the wrangling code will go here in order for automated
cleaning. For example, as we gather data, we want it to adhere to our schema
and instead of having to manually.
"""
    ...
    for match in matches:
        ...
        if i == 0 or ((match_locations[i]) - (match_locations[i - 1])) >= 100:
            ...
            split_matches.append(
                str(recipe[match_locations[i - 1]:match_locations[i]]))
