...
def load_params():
    ...
    elif NETWORK_TYPE == 'VGG16' or NETWORK_TYPE == 'ResNet50':
    ...
    LR = 0.00095  # general LR (0.001 recommended for adam optimizer)
    ...
    STORE_PATH = 'exploratory/trained_models/' + \
        MODEL_NAME  # models and evaluation results
